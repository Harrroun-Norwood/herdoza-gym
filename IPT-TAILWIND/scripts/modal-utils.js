...
export function initializePaymentMethodHandlers(form) {
  ...
  gcashRadio?.addEventListener("change", () => {
    ...
    if (payNowBtn) {
      payNowBtn.classList.remove("bg-gray-500", "bg-green-600", "hover:bg-gray-600", "hover:bg-green-700");
  ...
  onsiteRadio?.addEventListener("change", () => {
    ...
    if (payNowBtn) {
      payNowBtn.classList.remove("bg-gray-500", "bg-blue-600", "hover:bg-gray-600", "hover:bg-blue-700");
