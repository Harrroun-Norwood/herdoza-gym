document.addEventListener("DOMContentLoaded", () => {
  ...
  function hidePaymentModal() {
    if (paymentModal) {
      ...
      if (confirmPaymentBtn) {
        confirmPaymentBtn.classList.remove("bg-blue-600", "bg-green-600", "hover:bg-blue-700", "hover:bg-green-700");
  ...
  document.querySelectorAll('input[name="payment-method"]').forEach(input => {
    input.addEventListener("change", () => {
      ...
      if (confirmPaymentBtn) {
        confirmPaymentBtn.classList.remove("bg-gray-500", "bg-blue-600", "bg-green-600", "hover:bg-gray-600", "hover:bg-blue-700", "hover:bg-green-700");
